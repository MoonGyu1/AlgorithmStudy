...
public class Solution출퇴근길 {
	...
	static void dfs(int from, int to, int fromIdx, int toIdx) {
		// 1. 목적지에 도달하면 종료
		if(from == to) {
			return;
		}
